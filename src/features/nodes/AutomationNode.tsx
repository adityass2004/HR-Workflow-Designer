...
const AutomationNode: React.FC<NodeProps<AutomationNodeData>> = ({ data, selected }) => {
  return (
    ...
    `}>
      ...
      <div className="p-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-[10px] font-bold uppercase text-text-muted tracking-wider">Automation</span>
        </div>
